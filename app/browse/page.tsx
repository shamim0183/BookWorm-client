                ...
                >
                  ...
                  <div className="aspect-[2/3] bg-white/5 overflow-hidden relative">
                    ...
                    {(book.ratings?.average || book.averageRating) > 0 && (
                      <div className="absolute top-2 right-2 px-2.5 py-1.5 bg-black/40 backdrop-blur-md border border-white/20 rounded-lg flex items-center gap-1 shadow-lg">
                        <span className="text-yellow-400 text-sm">★</span>
                        <span className="text-white text-sm font-bold">
                          {(
                            book.ratings?.average || book.averageRating
                          ).toFixed(1)}
                        </span>
                      </div>
                    )}
